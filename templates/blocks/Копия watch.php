<?php 
	...
	elseif($watch['PART']=='keywords'):
		...
		{			
			echo "${watch['viewout_name']} ${watch['viewout_season']} сезон ${watch['viewout_series']} серия смотреть онлайн";
		}		
	elseif(! $watch['PART']):
?>
		<?php 
...
<!-- SHARE BUTTONS END -->
		...
		<div class="pages" series=1 style='margin-top:12px;position:static;margin-bottom:0px;line-height:23px'>
					<b>Сезоны</b> 	
					<span class="page_links">
						...
						<a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=2">6</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=2">7</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=3">8</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=4">9</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=5">10</a> 
					</span>
					<b>Серии</b>
					<span class="page_links">
						...
						<a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=2">9</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=2">10</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=3">11</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=4">12</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=5">13</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=5">14</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=5">15</a>
						<a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=2">16</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=2">17</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=3">18</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=4">19</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=5">20</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=5">21</a> <a class="page_link" href="http://localhost/vfilme/site2/engine/watch.php?page=5">22</a>
					</span>
					<div class=prev_next style='line-height:16px'>
