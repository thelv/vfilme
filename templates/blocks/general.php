	...
	<body>
		<div id=top>
			<div id=top_left>
				...
				<a class=label_link href="/%D1%81%D0%B5%D1%80%D0%B8%D0%B0%D0%BB%D1%8B"><<?php echo $h1; ?> class=h1>смотреть сериалы онлайн</<?php echo $h1; ?>></a>
			</div>
			<div id=top_right>
...
+' src="http://jsc.dt00.net/v/f/vfilme.ru.10210.js?t='
+MGCD.getYear()
+MGCD.getMonth()
+MGCD.getDate()
+MGCD.getHours()
+'" charset="windows-1251"></scr'+'ipt>');
		...
		<!-- <scrip t type="text/javascript">
			...
			document.write('<scr'+'ipt type="text/javascript" '+'src="http://jsg.dt00.net/v/f/vfilme.ru.4662.js?t='+MarketGidDate.getYear()+MarketGidDate.getMonth()+'"' + '" charset="windows-1251" ></scr'+'ipt>');
		</scrip t>  -->
