		<div id=left_row>
                        <div class=left_item>
				<a class=left_h href="serials.php" title="Все сериалы">
					Сериалы
				</a>
				<span class="fade"></span>
				<?php
					foreach($left_block['serials'] as $left_serial)
					{
                                                echo
                                                "
                                                    <div class=left_film>
                                                            <a title='смотреть онлайн' href='serial.php?serial=".urlencode($left_serial['alias'])."'><nobr>".htmlspecialchars($left_serial['name'])."</nobr></a>
                                                    </div>
                                                ";
					}
				?>
