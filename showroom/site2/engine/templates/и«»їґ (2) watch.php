...
<style>
	#right_row{margin-right:6px;width:204px;padding-top:32px;}
</style>
<!-- MarketGidGoods Start -->
<div id="MarketGid4662"><center>
...
+'src="http://jsg.dt00.net/v/f/vfilme.ru.4662.js?t='+MarketGidDate.getYear()+MarketGidDate.getMonth()+'"'
...
var ban_id='971';
														var size="160x600";	// размер баннера
														var cid="05c896665430ffff813e5215fe35fa56";
														var sa="";  // субаккаунт
													</script>
													<script language="JavaScript" type="text/javascript" src="http://t33.gameleads.ru/"></script>
